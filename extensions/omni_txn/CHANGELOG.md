...
* `omni_txn.retry` now accepts an optional `timeout` interval parameter [#973](https://github.com/omnigres/omnigres/pull/973)
...
[0.6.0]: [https://github.com/omnigres/omnigres/pull/973]
