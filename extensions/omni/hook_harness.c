...
void *saved_hooks[__OMNI_HOOK_TYPE_COUNT] = {0};
...
static inline void reorganize_hooks() {
...
static void omni_emit_log_hook(ErrorData *edata) { iterate_hooks(omni_hook_emit_log, edata); }
