 ...
 * @file ca-bundle.cc
 *
 * For the time being, we bundle the root certificate inside of the extension.
 * This may change at some point to allow for better upgrades.
 */

extern "C" {
const char *ca_bundle = R"ca-bundle(
##
## Bundle of CA Root Certificates
##
## Certificate data from Mozilla as of: Fri Apr 28 05:42:36 2023 GMT
##
